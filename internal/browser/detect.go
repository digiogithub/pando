...
//
// It is deliberately dependency-free (stdlib only) and shared: the browser_*
// agent tools and the design renderer both need to find a browser, and neither
// package may import the other.
package browser
