		...
		Fields: []settings.Field{
			{
				...
				Type:     settings.FieldText,
				Value:    bannedValue,
				HelpText: "Comma-separated list of commands to block. Replaces the default list when non-empty.",
			},
			{
				...
				Type:     settings.FieldText,
				Value:    allowedValue,
				HelpText: "Comma-separated list of commands to remove from the default banned list (e.g. curl,wget).",
			},
			{
