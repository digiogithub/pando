...
// EvaluatorPage is the public interface for the self-improvement page.
type EvaluatorPage interface {
	tea.Model
	layout.Sizeable
	layout.Bindings
}
...
func NewEvaluatorPage(svc evaluator.Service) EvaluatorPage {
	p := &evaluatorPage{
		evaluatorSvc: svc,
	}
